...
const db = mysql.createPool({
  host: "localhost",
  user: "root",
  password: "Poojitha@123*", // Change this to your actual password
  database: "auth_db",
  connectionLimit: 10,
});
...
const TWILIO_ACCOUNT_SID = "AC8629f151a75bb5d1ed11750e784ca984";
const TWILIO_AUTH_TOKEN = "6de405faa8bf4edffcb57b67cd869d23";
const TWILIO_PHONE_NUMBER = "+16085648081";
